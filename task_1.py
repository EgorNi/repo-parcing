...
params = {'text': name_of_vacancy, 'clusters': 'true', 'enable_snippets': 'true', 'page': 0}
headers = {
...
while True:
    ...
    for item in items:
        ...
        data['name'] = a.text
        data['city/region'] = item.find(attrs={'data-qa': 'vacancy-serp__vacancy-address'}).text
